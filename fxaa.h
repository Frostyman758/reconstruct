// This is a compute friendly version of the FXAA implementation
// Everything is kept the same where possible, with the exception 
// of texture sampling going to LDS instead of texture reads

#define FXAA_THREAD_COUNT 	128
#define FXAA_TILE_SIZE		32
...
struct FXAAConstantBuffer
{
	uint 	cBufferWidth;
	uint	cBufferHeight;
	float	cBufferWidthInv;
	float	cBufferHeightInv;
};
...
/*--------------------------------------------------------------------------*/
	...
	#define FxaaInt2 float2
	struct FxaaTex { SamplerState smpl; Texture2D tex; };
	#define FxaaTexTop(t, p) t.tex.SampleLOD(t.smpl, p, 0.0)
	#define FxaaTexOff(t, p, o, r) t.tex.SampleLOD(t.smpl, p, 0.0, (int2)o)
	#define FxaaTexAlpha4(t, p) t.tex.GatherAlpha(t.smpl, p)
	#define FxaaTexOffAlpha4(t, p, o) t.tex.GatherAlpha(t.smpl, p, o)
	#define FxaaTexGreen4(t, p) t.tex.GatherGreen(t.smpl, p)
	#define FxaaTexOffGreen4(t, p, o) t.tex.GatherGreen(t.smpl, p, o)
